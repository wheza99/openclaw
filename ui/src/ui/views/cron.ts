...
function getRunStatusOptions(): Array<{
  value: CronRunsStatusValue;
  label: string;
}> {
  return [
...
function getRunDeliveryOptions(): Array<{
  ...
  const submitDisabledReason =
    blockedByValidation && !props.canSubmit
      ? blockingFields.length === 1
        ...
        : t("cron.form.fixFieldsPlural", {
            count: String(blockingFields.length),
          })
      : "";
  return html`
    <section class="cron-workspace">
      ${renderCronJobsPanel(props, hasActiveJobsFilters)}

      <div
        class="cron-detail-panel ${isEditing ? "cron-detail-panel--form" : ""}"
      >
        ${
          !isEditing
            ? html`
              ${renderCronSummaryStrip(props)}
              ${renderCronRunsPanel(
                props,
                selectedRunTitle,
                runs,
            ...
            `
            : html`
              <section class="card cron-detail-form">
                <div class="cron-form-header">
                  <div class="cron-form-header__text">
                  ...
                  <div class="cron-form-header__actions">
                    <button
                      class="btn"
                      ?disabled=${props.busy}
                ...
                <div class="cron-form">
                  ...
                  <details class="cron-form-section">
                    <summary class="cron-form-section__summary">
                      <span class="cron-form-section__title">
                        ${t("cron.form.basics")}
                        <span class="cron-required-marker" aria-hidden="true">*</span>
                      </span>
                      <span class="cron-form-section__sub">
                    ...
                    <div class="form-grid cron-form-grid">
                      ...
                      <label
                        class="field checkbox cron-checkbox cron-checkbox-inline"
                      >
                        <input
                          type="checkbox"
                  ...
                  <details class="cron-form-section" ?open=${isEditing}>
                    <summary class="cron-form-section__summary">
                      <span class="cron-form-section__title">
                    ...
                    <div class="form-grid cron-form-grid">
                      <div class="field cron-span-2 cron-prompt-field">
                        <div class="cron-prompt-header">
                          ${renderFieldLabel(
                          ...
                          <button
                            type="button"
                            class="btn btn--sm cron-prompt-fullscreen"
                            @click=${(e: Event) => {
                              const btn = e.currentTarget as HTMLElement;
                              const wrapper = btn.closest(".cron-prompt-field") as HTMLElement;
                              wrapper.classList.toggle("cron-prompt-field--fullscreen");
                              const isFullscreen = wrapper.classList.contains(
                                "cron-prompt-field--fullscreen",
                              );
                              btn
                                .querySelector(".cron-prompt-fullscreen__icon--expand")
                                ?.classList.toggle("hidden", isFullscreen);
                              btn
                                .querySelector(".cron-prompt-fullscreen__icon--minimize")
                                ?.classList.toggle("hidden", !isFullscreen);
                            }}
                          >
                            <span class="cron-prompt-fullscreen__icon cron-prompt-fullscreen__icon--expand">${icons.maximize}</span>
                            <span class="cron-prompt-fullscreen__icon cron-prompt-fullscreen__icon--minimize hidden">${icons.minimize}</span>
                          </button>
                        </div>
                        <textarea
                      ...
                      <label class="field">
                        ...
                        >
                          ...
                          <option value="next-heartbeat">
                            ${t("cron.form.nextHeartbeat")}
                          </option>
                        </select>
                        <div class="cron-help">
                          ${t("cron.form.wakeModeHelp")}
                        </div>
                      </label>
                  ...
                  <details class="cron-form-section">
                    ...
                    <div class="form-grid cron-form-grid">
                      <label
                        class="field ${selectedDeliveryMode === "none" ? "cron-span-2" : ""}"
                      >
                      ...
                      ${
                        selectedDeliveryMode !== "none"
                          ? html`
                            <label
                              class="field ${
                                selectedDeliveryMode === "webhook" ? "cron-span-2" : ""
                              }"
                            >
                              ${renderFieldLabel(
                                ...
                                selectedDeliveryMode === "webhook"
                                  ? html`
                                    <input
                                      ...
                                      aria-invalid=${
                                        props.fieldErrors.deliveryTo ? "true" : "false"
                                      }
                                      aria-describedby=${ifDefined(
                              ...
                              ${
                                selectedDeliveryMode === "announce"
                                  ? html`
                                    <div class="cron-help">
                                      ${t("cron.form.channelHelp")}
                                    </div>
                                  `
                                  : html`
                                    <div class="cron-help">
                                      ${t("cron.form.webhookHelp")}
                                    </div>
                                  `
                              }
                            </label>
                  ...
                  <details class="cron-form-section">
                    ...
                    <div class="form-grid cron-form-grid">
                      <label class="field checkbox cron-checkbox">
                        ...
                        />
                        <span class="field-checkbox__label"
                          >${t("cron.form.deleteAfterRun")}</span
                        >
                        <div class="cron-help">
                          ${t("cron.form.deleteAfterRunHelp")}
                        </div>
                      </label>
                      <label class="field checkbox cron-checkbox">
                        <input
                      ...
                      <label class="field cron-span-2">
                        ...
                        />
                        <div class="cron-help">
                          Optional routing key for job delivery and wake
                          routing.
                        </div>
                      </label>
                      ${
                        isCronSchedule
                          ? html`
                            <label
                              class="field checkbox cron-checkbox cron-span-2"
                            >
                              <input
                                type="checkbox"
                        ...
                        isAgentTurn
                          ? html`
                            <label class="field cron-span-2">
                              ...
                              />
                              <div class="cron-help">
                                Optional channel account ID for multi-account
                                setups.
                              </div>
                            </label>
                            <label
                            ...
                            >
                              ...
                              >
                              <div class="cron-help">
                                Use lightweight bootstrap context for this agent
                                job.
                              </div>
                            </label>
                            <label class="field">
                          ...
                          ? html`
                            <label class="field cron-span-2">
                              ...
                              >
                                ...
                                <option value="custom">
                                  Custom per-job settings
                                </option>
                              </select>
                              <div class="cron-help">
                                Control when this job sends repeated-failure
                                alerts.
                              </div>
                            </label>
                            ${
                              props.form.failureAlertMode === "custom"
                                ? html`
                                  ...
                                  <label class="field">
                                    ...
                                    />
                                    <div class="cron-help">
                                      Optional recipient override for failure
                                      alerts.
                                    </div>
                                  </label>
                                `
                  ...
                  blockedByValidation
                    ? html`
                      <div
                        ...
                        aria-live="polite"
                      >
                        <div class="cron-form-status__title">
      ...
      <label class="field">
        ...
        ${
          props.fieldErrors.cronExpr
            ...
            : html`<div class="cron-help">${t("cron.form.jitterHelp")}</div>`
        }
      </label>
      <label class="field">
        ${renderFieldLabel(t("cron.form.timezoneOptional"))}
        <input
          .value=${form.cronTz}
...
function renderCronJobsPanel(props: CronProps, hasActiveJobsFilters: boolean) {
  return html`
    <section class="cron-jobs-panel">
      <div class="cron-jobs-header">
        <div class="field cron-filter-search">
          <span class="field-icon">${icons.search}</span>
          <input
        ...
        <details class="cron-filter-popover">
          <summary class="btn btn--sm cron-filter-popover__trigger">
            ${icons.filter}
          </summary>
          <div class="cron-filter-popover__panel">
            ...
            <label class="field">
              ...
              >
                ...
                <option value="updatedAtMs">
                  ${t("cron.jobs.recentlyUpdated")}
                </option>
...
function renderCronSummaryStrip(props: CronProps) {
  return html`
...
function renderCronRunsPanel(
  props: CronProps,
  selectedRunTitle: string,
  runs: CronRunLogEntry[],
  runStatusOptions: Array<{ value: CronRunsStatusValue; label: string }>,
  runDeliveryOptions: Array<{ value: CronDeliveryStatus; label: string }>,
    ...
    <div class=${itemClass} @click=${() => props.onLoadRuns(job.id)}>
      <div class="cron-job-header">
        <div class="cron-job-title">
          <span class="cron-job-icon ${job.enabled ? "cron-job-icon--enabled" : "cron-job-icon--disabled"}">${icons.loader}</span>
          <span class="list-title">${job.name}</span>
        </div>
        <details class="cron-job-menu">
          <summary class="cron-job-menu__trigger">
            <span class="cron-job-menu__icon">${icons.moreHorizontal}</span>
          </summary>
          <div class="cron-job-menu__dropdown">
            <button
              class="cron-job-menu__item"
              ?disabled=${props.busy}
              @click=${(event: Event) => {
            ...
            <button
              class="cron-job-menu__item cron-job-menu__item--danger"
              ?disabled=${props.busy}
              @click=${(event: Event) => {
                event.stopPropagation();
...
function renderJobPayload(job: CronJob) {
  if (job.payload.kind === "systemEvent") {
    return html`<span class="muted cron-job-detail-value cron-job-prompt-clamp">${job.payload.text}</span>`;
  }

  return html`<span class="muted cron-job-detail-value cron-job-prompt-clamp">${job.payload.message}</span>`;
}
